...
function optionsframework_options() {
	...
	$options[] = array(
		'name'	=> __('SalesForce', 'options_check'),
		'type'	=> 'heading');
	...
	$options[] = array(
		...
		'desc'	=> '',
		'id'	=> 'sforce_instance_url',
		'std'	=> '',
		'type'	=> 'readonly');

	$options[] = array(
		'name'	=> __('ShareFile', 'options_check'),
		'type'	=> 'heading');

	$options[] = array(
		'name'	=> 'ShareFile OAuth Token',
		'desc'	=> '',
		'id'	=> 'sfile_oauth_token',
		'std'	=> '',
		'type'	=> 'readonly');

	$options[] = array(
		'name'	=> 'ShareFile API URL Base',
		'desc'	=> '',
		'id'	=> 'sfile_api_url_base',
		'std'	=> '',
		'type'	=> 'readonly');
...
function optionsframework_options_examples() {
